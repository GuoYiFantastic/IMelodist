...
# dataset = load_dataset('sander-wood/irishman',cache_dir='../irishman')['train']
# dataset.to_json('./irishman-cre.json')

# dataset = load_dataset('m-a-p/musicpile',cache_dir='../musicpile')
# dataset_irishman = dataset.filter(lambda example: 'irishman' in example['src'])['train']
# dataset_irishman.to_json('./irishman-sft.json')
